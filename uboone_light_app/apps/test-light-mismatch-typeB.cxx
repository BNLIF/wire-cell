...
int main(int argc, char* argv[])
{
  ...
  cout << em("load clusters from file") << endl;
   ...
   //FlashTPCBundleSelection imb = WireCell2dToy::tpc_light_match(time_offset,nrebin,group_clusters,flashes, run_no, true); // assume data
   WireCell::Photon_Library pl(run_no,true);
   FlashTPCBundleSelection imb = WireCell2dToy::tpc_light_match(time_offset,nrebin,&pl,group_clusters,flashes, run_no, true); // assume data
   ...
   FlashTPCBundleSelection matched_bundles = WireCell2dToy::tpc_light_match(time_offset,nrebin,&pl,group_clusters,flashes);
