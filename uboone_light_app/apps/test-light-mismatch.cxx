...
int main(int argc, char* argv[])
{
  ...
  //FlashTPCBundleSelection matched_bundles = WCP2dToy::tpc_light_match(time_offset,nrebin,group_clusters,flashes, run_no, true); // assume Data here ...
  WCP::Photon_Library pl(eventTime,run_no,true);
  FlashTPCBundleSelection matched_bundles = WCP2dToy::tpc_light_match(eventTime,time_offset,nrebin,&pl,group_clusters,flashes, run_no, true); // assume Data here ...
