...
int main(int argc, char* argv[])
{
  ...
  //FlashTPCBundleSelection matched_bundles = WireCell2dToy::tpc_light_match(time_offset,nrebin,group_clusters,flashes, run_no, true); // assume Data here ...
  WireCell2dToy::Photon_Library pl(run_no,true);
  FlashTPCBundleSelection matched_bundles = WireCell2dToy::tpc_light_match(time_offset,nrebin,&pl,group_clusters,flashes, run_no, true); // assume Data here ...
