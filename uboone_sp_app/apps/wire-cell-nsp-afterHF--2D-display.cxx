...
int main(int argc, char* argv[])
{
  ...
  WireCellSst::DatauBooNEFrameDataSource_afterHF data_fds(root_file,gds,total_time_bin);
  ...
  TFile *file = new TFile(Form("nsp_afterHF_2D_display_%d_%d_%d.root",run_no,subrun_no,event_no),"RECREATE");
