...
int main(int argc, char* argv[])
{
  ...
  WireCellSst::DatauBooNEFrameDataSource data_fds(root_file,gds,total_time_bin,0);
  if (save_file != 2){
    data_fds.jump_no_noise(eve_num);
    if (save_file == 1)
      data_fds.Save();
  }
  ...
  // Todo: change this part to be the truth information loaded from celltree (1/5/2017) ... 
