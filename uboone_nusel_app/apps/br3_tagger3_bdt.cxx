...
void convert_file(){
  ...
  sig->SetBranchAddress("br3_3_v_energy",&br3_3_v_energy);
  sig->SetBranchAddress("br3_3_v_angle",&br3_3_v_angle);
  sig->SetBranchAddress("br3_3_v_dir_length",&br3_3_v_dir_length);
  sig->SetBranchAddress("br3_3_v_length",&br3_3_v_length);
  sig->SetBranchAddress("br3_3_v_flag",&br3_3_v_flag);
  
  bkg->SetBranchAddress("br3_3_v_energy",&br3_3_v_energy);
  bkg->SetBranchAddress("br3_3_v_angle",&br3_3_v_angle);
  bkg->SetBranchAddress("br3_3_v_dir_length",&br3_3_v_dir_length);
  bkg->SetBranchAddress("br3_3_v_length",&br3_3_v_length);
  bkg->SetBranchAddress("br3_3_v_flag",&br3_3_v_flag);
  ...
  float br3_3_v_length_f;
  float br3_3_v_flag_f;

  Tsig->Branch("br3_3_v_energy",&br3_3_v_energy_f,"data/F");
  Tsig->Branch("br3_3_v_angle",&br3_3_v_angle_f,"data/F");
  Tsig->Branch("br3_3_v_dir_length",&br3_3_v_dir_length_f,"data/F");
  Tsig->Branch("br3_3_v_length",&br3_3_v_length_f,"data/F");
  Tsig->Branch("br3_3_v_flag",&br3_3_v_flag_f,"data/F");
  
  Tbkg->Branch("br3_3_v_energy",&br3_3_v_energy_f,"data/F");
  Tbkg->Branch("br3_3_v_angle",&br3_3_v_angle_f,"data/F");
  Tbkg->Branch("br3_3_v_dir_length",&br3_3_v_dir_length_f,"data/F");
  Tbkg->Branch("br3_3_v_length",&br3_3_v_length_f,"data/F");
  Tbkg->Branch("br3_3_v_flag",&br3_3_v_flag_f,"data/F");
  ...
  for (Int_t i=0;i!=sig->GetEntries();i++){
    ...
    for (size_t j=0;j!=br3_3_v_energy->size();j++){
      br3_3_v_energy_f = br3_3_v_energy->at(j);
      br3_3_v_angle_f = br3_3_v_angle->at(j);
      br3_3_v_dir_length_f = br3_3_v_dir_length->at(j);
      br3_3_v_length_f = br3_3_v_length->at(j);
      br3_3_v_flag_f = br3_3_v_flag->at(j);
...
void InitBDT_r1()
{
    ...
    dataloader->AddVariable("br3_3_v_energy","br3_3_v_energy","MeV",'F');
    dataloader->AddVariable("br3_3_v_angle","br3_3_v_angle","deg",'F');
    dataloader->AddVariable("br3_3_v_dir_length","br3_3_v_dir_length","cm",'F');
    dataloader->AddVariable("br3_3_v_length","br3_3_v_length","cm",'F');
    ...
    TCut mycut_s = "1>0 "; // 1059630
    TCut mycut_b = "br3_3_v_flag==0 "; // 2350
    
    dataloader->PrepareTrainingAndTestTree( mycut_s, mycut_b,
        "nTrain_Signal=400000:"
        "nTrain_Background=2000:"
	"nTest_Signal=20000:"
        "nTest_Background=350:"
        "SplitMode=Random:"
        "NormMode=NumEvents:"
        "!V" );
...
void InitBDT_r2()
{
    ...
    // Apply additional cuts on the signal and background samples (can be different)
    TCut mycut_s = "1>0 "; // 
    TCut mycut_b = "(br3_3_v_flag==0 || br3_3_v_bdt < -0.07)"; // 6104
    
    dataloader->PrepareTrainingAndTestTree( mycut_s, mycut_b,
        "nTrain_Signal=200000:"
        "nTrain_Background=5100:"
	"nTest_Signal=20000:"
        "nTest_Background=1004:"
        "SplitMode=Random:"
        "NormMode=NumEvents:"
        "!V" );
...
void TestEvaluate(TString filename)
{
  ...
  Tsig->Branch("br3_3_v_energy",&br3_3_v_energy,"data/F");
  Tsig->Branch("br3_3_v_angle",&br3_3_v_angle,"data/F");
  Tsig->Branch("br3_3_v_dir_length",&br3_3_v_dir_length,"data/F");
  Tsig->Branch("br3_3_v_length",&br3_3_v_length,"data/F");
  Tsig->Branch("br3_3_v_flag",&br3_3_v_flag,"data/F");
  
  Tbkg->Branch("br3_3_v_energy",&br3_3_v_energy,"data/F");
  Tbkg->Branch("br3_3_v_angle",&br3_3_v_angle,"data/F");
  Tbkg->Branch("br3_3_v_dir_length",&br3_3_v_dir_length,"data/F");
  Tbkg->Branch("br3_3_v_length",&br3_3_v_length,"data/F");
  Tbkg->Branch("br3_3_v_flag",&br3_3_v_flag,"data/F");

  Tsig->Branch("br3_3_v_bdt",&bdt_value,"data/F");
  Tbkg->Branch("br3_3_v_bdt",&bdt_value,"data/F");
