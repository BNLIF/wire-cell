...
void convert_file(){
  ...
  float sig_1_v_angle_f;
  float sig_1_v_flag_single_shower_f;
  float sig_1_v_energy_f;
  float sig_1_v_energy_1_f;
  float sig_1_v_flag_f;

  Tsig->Branch("sig_1_v_angle",&sig_1_v_angle_f,"data/F");
  Tsig->Branch("sig_1_v_flag_single_shower",&sig_1_v_flag_single_shower_f,"data/F");
  Tsig->Branch("sig_1_v_energy",&sig_1_v_energy_f,"data/F");
  Tsig->Branch("sig_1_v_energy_1",&sig_1_v_energy_1_f,"data/F");
  Tsig->Branch("sig_1_v_flag",&sig_1_v_flag_f,"data/F");

  Tbkg->Branch("sig_1_v_angle",&sig_1_v_angle_f,"data/F");
  Tbkg->Branch("sig_1_v_flag_single_shower",&sig_1_v_flag_single_shower_f,"data/F");
  Tbkg->Branch("sig_1_v_energy",&sig_1_v_energy_f,"data/F");
  Tbkg->Branch("sig_1_v_energy_1",&sig_1_v_energy_1_f,"data/F");
  Tbkg->Branch("sig_1_v_flag",&sig_1_v_flag_f,"data/F");
  
  for (Int_t i=0;i!=sig->GetEntries();i++){
    sig->GetEntry(i);
    
    
    for (size_t j=0;j!=sig_1_v_angle->size();j++){
      sig_1_v_angle_f = sig_1_v_angle->at(j);
      sig_1_v_flag_single_shower_f = sig_1_v_flag_single_shower->at(j);
      sig_1_v_energy_f = sig_1_v_energy->at(j);
      sig_1_v_energy_1_f = sig_1_v_energy_1->at(j);
      sig_1_v_flag_f = sig_1_v_flag->at(j);
...
void InitBDT_r1()
{
    ...
    // float sig_1_v_energy_1_f;
    // float sig_1_v_flag_f;
    dataloader->AddVariable("sig_1_v_angle","sig_1_v_angle","",'F');
    dataloader->AddVariable("sig_1_v_flag_single_shower","sig_1_v_flag_single_shower","",'F');
    dataloader->AddVariable("sig_1_v_energy","sig_1_v_energy","MeV",'F');
    dataloader->AddVariable("sig_1_v_energy_1","sig_1_v_energy_1","MeV",'F');
    ...
    TCut mycut_s = "1>0 "; // 110779
    TCut mycut_b = "sig_1_v_flag==0 "; // 2094
    
    dataloader->PrepareTrainingAndTestTree( mycut_s, mycut_b,
        "nTrain_Signal=40000:"
        "nTrain_Background=1800:"
	"nTest_Signal=10000:"
        "nTest_Background=294:"
        "SplitMode=Random:"
        "NormMode=NumEvents:"
        "!V" );
...
void InitBDT_r2()
{
  factory = new TMVA::Factory( "Test", output,
    ...
    TCut mycut_b = "(sig_1_v_flag==0 || sig_1_v_bdt < 0.1) "; // 5019
    
    dataloader->PrepareTrainingAndTestTree( mycut_s, mycut_b,
        "nTrain_Signal=40000:"
        "nTrain_Background=4500:"
	"nTest_Signal=10000:"
        "nTest_Background=519:"
        "SplitMode=Random:"
        "NormMode=NumEvents:"
        "!V" );
