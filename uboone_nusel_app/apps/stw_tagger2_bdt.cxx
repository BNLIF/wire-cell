...
void convert_file(){
  ...
  sig->SetBranchAddress("stw_2_v_medium_dQ_dx", &stw_2_v_medium_dQ_dx);
  sig->SetBranchAddress("stw_2_v_energy", &stw_2_v_energy);
  sig->SetBranchAddress("stw_2_v_angle", &stw_2_v_angle);
  sig->SetBranchAddress("stw_2_v_dir_length", &stw_2_v_dir_length);
  sig->SetBranchAddress("stw_2_v_max_dQ_dx", &stw_2_v_max_dQ_dx);
  sig->SetBranchAddress("stw_2_v_flag", &stw_2_v_flag);

  bkg->SetBranchAddress("stw_2_v_medium_dQ_dx", &stw_2_v_medium_dQ_dx);
  bkg->SetBranchAddress("stw_2_v_energy", &stw_2_v_energy);
  bkg->SetBranchAddress("stw_2_v_angle", &stw_2_v_angle);
  bkg->SetBranchAddress("stw_2_v_dir_length", &stw_2_v_dir_length);
  bkg->SetBranchAddress("stw_2_v_max_dQ_dx", &stw_2_v_max_dQ_dx);
  bkg->SetBranchAddress("stw_2_v_flag", &stw_2_v_flag);
  ...
  float stw_2_v_medium_dQ_dx_f;
  float stw_2_v_energy_f;
  float stw_2_v_angle_f;
  float stw_2_v_dir_length_f;
  float stw_2_v_max_dQ_dx_f;
  float stw_2_v_flag_f;

  Tsig->Branch("stw_2_v_medium_dQ_dx", &stw_2_v_medium_dQ_dx_f,"data/F");
  Tsig->Branch("stw_2_v_energy", &stw_2_v_energy_f,"data/F");
  Tsig->Branch("stw_2_v_angle", &stw_2_v_angle_f,"data/F");
  Tsig->Branch("stw_2_v_dir_length", &stw_2_v_dir_length_f,"data/F");
  Tsig->Branch("stw_2_v_max_dQ_dx", &stw_2_v_max_dQ_dx_f,"data/F");
  Tsig->Branch("stw_2_v_flag", &stw_2_v_flag_f,"data/F");

  Tbkg->Branch("stw_2_v_medium_dQ_dx", &stw_2_v_medium_dQ_dx_f,"data/F");
  Tbkg->Branch("stw_2_v_energy", &stw_2_v_energy_f,"data/F");
  Tbkg->Branch("stw_2_v_angle", &stw_2_v_angle_f,"data/F");
  Tbkg->Branch("stw_2_v_dir_length", &stw_2_v_dir_length_f,"data/F");
  Tbkg->Branch("stw_2_v_max_dQ_dx", &stw_2_v_max_dQ_dx_f,"data/F");
  Tbkg->Branch("stw_2_v_flag", &stw_2_v_flag_f,"data/F");
  
  
  for (Int_t i=0;i!=sig->GetEntries();i++){
    sig->GetEntry(i);
    
    for (size_t j=0;j!=stw_2_v_medium_dQ_dx->size();j++){
      stw_2_v_medium_dQ_dx_f = stw_2_v_medium_dQ_dx->at(j);
      stw_2_v_energy_f = stw_2_v_energy->at(j);
      stw_2_v_angle_f = stw_2_v_angle->at(j);
      stw_2_v_dir_length_f = stw_2_v_dir_length->at(j);
      stw_2_v_max_dQ_dx_f = stw_2_v_max_dQ_dx->at(j);
      stw_2_v_flag_f = stw_2_v_flag->at(j);
...
void InitBDT_r1()
{
    ...
    // [all types of expressions that can also be parsed by TTree::Draw( "expression" )]
     ...
     // float stw_2_v_max_dQ_dx_f;
     // float stw_2_v_flag_f;
    dataloader->AddVariable("stw_2_v_medium_dQ_dx","stw_2_v_medium_dQ_dx","MeV/cm",'F');
    dataloader->AddVariable("stw_2_v_energy","stw_2_v_energy","MeV",'F');
    dataloader->AddVariable("stw_2_v_angle","stw_2_v_angle","deg",'F');
    dataloader->AddVariable("stw_2_v_dir_length","stw_2_v_dir_length","cm",'F');
    dataloader->AddVariable("stw_2_v_max_dQ_dx","stw_2_v_max_dQ_dx","MeV/cm",'F');
    ...
    TCut mycut_b = "stw_2_v_flag==0&& (!(truth_nue==1 && truth_CC==1)) "; // 120/40640, adding mip_id 340
    
    dataloader->PrepareTrainingAndTestTree( mycut_s, mycut_b,
        "nTrain_Signal=30000:"
        "nTrain_Background=100:"
	"nTest_Signal=15000:"
        "nTest_Background=20:"
        "SplitMode=Random:"
        "NormMode=NumEvents:"
...
void InitBDT_r2()
{
  factory = new TMVA::Factory( "Test", output,
    ...
    TCut mycut_s = "1>0"; // 2 / 97209, adding pi0 50
    TCut mycut_b = "(stw_2_v_flag==0 || stw_2_v_bdt < 0) && (!(truth_nue==1 && truth_CC==1))"; // 641/40640, adding mip_id 340
    
    dataloader->PrepareTrainingAndTestTree( mycut_s, mycut_b,
        "nTrain_Signal=30000:"
        "nTrain_Background=500:"
	"nTest_Signal=15000:"
        "nTest_Background=140:"
        "SplitMode=Random:"
        "NormMode=NumEvents:"
        "!V" );
...
void TestEvaluate(TString filename)
{
  ...
  Tsig->Branch("stw_2_v_medium_dQ_dx", &stw_2_v_medium_dQ_dx,"data/F");
  Tsig->Branch("stw_2_v_energy", &stw_2_v_energy,"data/F");
  Tsig->Branch("stw_2_v_angle", &stw_2_v_angle,"data/F");
  Tsig->Branch("stw_2_v_dir_length", &stw_2_v_dir_length,"data/F");
  Tsig->Branch("stw_2_v_max_dQ_dx", &stw_2_v_max_dQ_dx,"data/F");
  Tsig->Branch("stw_2_v_flag", &stw_2_v_flag,"data/F");

  Tbkg->Branch("stw_2_v_medium_dQ_dx", &stw_2_v_medium_dQ_dx,"data/F");
  Tbkg->Branch("stw_2_v_energy", &stw_2_v_energy,"data/F");
  Tbkg->Branch("stw_2_v_angle", &stw_2_v_angle,"data/F");
  Tbkg->Branch("stw_2_v_dir_length", &stw_2_v_dir_length,"data/F");
  Tbkg->Branch("stw_2_v_max_dQ_dx", &stw_2_v_max_dQ_dx,"data/F");
  Tbkg->Branch("stw_2_v_flag", &stw_2_v_flag,"data/F");

  Tsig->Branch("stw_2_v_bdt",&bdt_value,"data/F");
  Tbkg->Branch("stw_2_v_bdt",&bdt_value,"data/F");
