...
void InitBDT_r1()
{
    ...
    dataloader->AddVariable("mip_quality_energy","mip_quality_energy","MeV",'F');
    dataloader->AddVariable("mip_quality_overlap","mip_quality_overlap","",'F');
    dataloader->AddVariable("mip_quality_n_showers","mip_quality_n_showers","",'F');
    dataloader->AddVariable("mip_quality_n_tracks","mip_quality_n_tracks","",'F');
    dataloader->AddVariable("mip_quality_flag_inside_pi0","mip_quality_flag_inside_pi0","",'F');
    dataloader->AddVariable("mip_quality_n_pi0_showers","mip_quality_n_pi0_showers","",'F');
    dataloader->AddVariable("mip_quality_shortest_length","mip_quality_shortest_length","cm",'F');
    dataloader->AddVariable("mip_quality_acc_length","mip_quality_acc_length","cm",'F');
    dataloader->AddVariable("mip_quality_shortest_angle","mip_quality_shortest_angle","",'F');
    dataloader->AddVariable("mip_quality_flag_proton","mip_quality_flag_proton","",'F');
