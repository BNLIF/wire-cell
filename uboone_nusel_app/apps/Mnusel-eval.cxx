...
int main(int argc, char* argv[])
{
  ...
  // form boundaries for the bad cells ... 
   ...
   WCP2dToy::ToyLightReco uboone_flash(filename, 1, is_mc); // (filename, input type: 1= imagingoutput, "Trun"; default/not specfified: path "Event/Sim", data type: 0=data, 1=MC  
