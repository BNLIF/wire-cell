...
void InitBDT_r1()
{
    ...
    TCut mycut_s = "1>0 "; //   34/  82011
    TCut mycut_b = "br3_6_v_flag==0 && (!(truth_nue==1 && truth_CC==1))"; //  146/26800
    
    dataloader->PrepareTrainingAndTestTree( mycut_s, mycut_b,
        "nTrain_Signal=40000:"
        "nTrain_Background=120:"
	"nTest_Signal=10000:"
        "nTest_Background=26:"
        "SplitMode=Random:"
        "NormMode=NumEvents:"
...
void InitBDT_r2()
{
   factory = new TMVA::Factory( "Test", output,
    ...
    // Apply additional cuts on the signal and background samples (can be different)
    TCut mycut_s = "1>0 "; // 
    TCut mycut_b = "(br3_6_v_flag==0 || br3_6_v_bdt < 0) && (!(truth_nue==1 && truth_CC==1))"; // 413
    
    dataloader->PrepareTrainingAndTestTree( mycut_s, mycut_b,
        "nTrain_Signal=30000:"
        "nTrain_Background=360:"
	"nTest_Signal=10000:"
        "nTest_Background=53:"
        "SplitMode=Random:"
        "NormMode=NumEvents:"
