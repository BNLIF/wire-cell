...
void convert_file(){
  ...
  sig->SetBranchAddress("stw_4_v_angle",&stw_4_v_angle);
  sig->SetBranchAddress("stw_4_v_dis",&stw_4_v_dis);
  sig->SetBranchAddress("stw_4_v_energy",&stw_4_v_energy);
  sig->SetBranchAddress("stw_4_v_flag",&stw_4_v_flag);

  bkg->SetBranchAddress("stw_4_v_angle",&stw_4_v_angle);
  bkg->SetBranchAddress("stw_4_v_dis",&stw_4_v_dis);
  bkg->SetBranchAddress("stw_4_v_energy",&stw_4_v_energy);
  bkg->SetBranchAddress("stw_4_v_flag",&stw_4_v_flag);
...
Tsig->Branch("truth_inFV",&truth_inFV,"data/I");
  ...
  float stw_4_v_angle_f;
  float stw_4_v_dis_f;
  float stw_4_v_energy_f;
  float stw_4_v_flag_f;

  Tsig->Branch("stw_4_v_angle",&stw_4_v_angle_f,"data/F");
  Tsig->Branch("stw_4_v_dis",&stw_4_v_dis_f,"data/F");
  Tsig->Branch("stw_4_v_energy",&stw_4_v_energy_f,"data/F");
  Tsig->Branch("stw_4_v_flag",&stw_4_v_flag_f,"data/F");


  Tbkg->Branch("stw_4_v_angle",&stw_4_v_angle_f,"data/F");
  Tbkg->Branch("stw_4_v_dis",&stw_4_v_dis_f,"data/F");
  Tbkg->Branch("stw_4_v_energy",&stw_4_v_energy_f,"data/F");
  Tbkg->Branch("stw_4_v_flag",&stw_4_v_flag_f,"data/F");
  
  for (Int_t i=0;i!=sig->GetEntries();i++){
    sig->GetEntry(i);
    
    for (size_t j=0;j!=stw_4_v_angle->size();j++){
      stw_4_v_angle_f = stw_4_v_angle->at(j);
      stw_4_v_dis_f = stw_4_v_dis->at(j);
      stw_4_v_energy_f = stw_4_v_energy->at(j);
      stw_4_v_flag_f = stw_4_v_flag->at(j);
...
void InitBDT_r1()
{
    ...
    dataloader->AddVariable("stw_4_v_angle","stw_4_v_angle","deg",'F');
    dataloader->AddVariable("stw_4_v_dis","stw_4_v_dis","cm",'F');
    dataloader->AddVariable("stw_4_v_energy","stw_4_v_energy","MeV",'F');
    ...
    TCut mycut_s = "1>0"; // 8 / 63993, adding pi0 50
    TCut mycut_b = "stw_4_v_flag==0 && (!(truth_nue==1 && truth_CC==1))"; // 117/29591, adding mip_id 340
    
    dataloader->PrepareTrainingAndTestTree( mycut_s, mycut_b,
        "nTrain_Signal=30000:"
        "nTrain_Background=95:"
	"nTest_Signal=15000:"
        "nTest_Background=12:"
        "SplitMode=Random:"
        "NormMode=NumEvents:"
...
void InitBDT_r2()
{
   factory = new TMVA::Factory( "Test", output,
    ...
    TCut mycut_s = "1>0"; // 8 / 63993, adding pi0 50
    TCut mycut_b = "(stw_4_v_flag==0 || stw_4_v_bdt < 0) && (!(truth_nue==1 && truth_CC==1))"; // 296/29591, adding mip_id 340
    
    dataloader->PrepareTrainingAndTestTree( mycut_s, mycut_b,
        "nTrain_Signal=30000:"
        "nTrain_Background=260:"
	"nTest_Signal=15000:"
        "nTest_Background=42:"
        "SplitMode=Random:"
        "NormMode=NumEvents:"
...
Tsig->Branch("truth_inFV",&truth_inFV,"data/I");
  ...
  Tsig->Branch("stw_4_v_angle",&stw_4_v_angle,"data/F");
  Tsig->Branch("stw_4_v_dis",&stw_4_v_dis,"data/F");
  Tsig->Branch("stw_4_v_energy",&stw_4_v_energy,"data/F");
  Tsig->Branch("stw_4_v_flag",&stw_4_v_flag,"data/F");


  Tbkg->Branch("stw_4_v_angle",&stw_4_v_angle,"data/F");
  Tbkg->Branch("stw_4_v_dis",&stw_4_v_dis,"data/F");
  Tbkg->Branch("stw_4_v_energy",&stw_4_v_energy,"data/F");
  Tbkg->Branch("stw_4_v_flag",&stw_4_v_flag,"data/F");

  Tsig->Branch("stw_4_v_bdt",&bdt_value,"data/F");
  Tbkg->Branch("stw_4_v_bdt",&bdt_value,"data/F");
