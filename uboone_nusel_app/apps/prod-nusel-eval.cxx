...
int main(int argc, char* argv[])
{
  ...
  // form boundaries for the bad cells ... 
   ...
   if(((datatier==0 && ((triggerbits>>9) & 1U)) || datatier==1) && time_offset<7){ lowerwindow=3.5625; upperwindow=5.34376; } // BNB EXT & overlay
   if( ((datatier==0 && ((triggerbits>>9) & 1U)) || datatier==1) && time_offset >= 7 ){ lowerwindow=5.3045; upperwindow=17.0233; } // EXTNUMI, overlay
