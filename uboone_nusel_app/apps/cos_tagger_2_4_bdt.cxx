...
void convert_file(){
 ...
 tree0->SetBranchAddress("cosmict_flag_2", &cosmict_flag_2);
 tree0->SetBranchAddress("cosmict_2_filled", &cosmict_2_filled);
 tree0->SetBranchAddress("cosmict_2_particle_type", &cosmict_2_particle_type);
 tree0->SetBranchAddress("cosmict_2_n_muon_tracks", &cosmict_2_n_muon_tracks);
 tree0->SetBranchAddress("cosmict_2_total_shower_length", &cosmict_2_total_shower_length);
 tree0->SetBranchAddress("cosmict_2_flag_inside", &cosmict_2_flag_inside);
 tree0->SetBranchAddress("cosmict_2_angle_beam", &cosmict_2_angle_beam);
 tree0->SetBranchAddress("cosmict_2_flag_dir_weak", &cosmict_2_flag_dir_weak);
 tree0->SetBranchAddress("cosmict_2_dQ_dx_end", &cosmict_2_dQ_dx_end);
 tree0->SetBranchAddress("cosmict_2_dQ_dx_front", &cosmict_2_dQ_dx_front);
 tree0->SetBranchAddress("cosmict_2_theta", &cosmict_2_theta);
 tree0->SetBranchAddress("cosmict_2_phi", &cosmict_2_phi);
 tree0->SetBranchAddress("cosmict_2_valid_tracks", &cosmict_2_valid_tracks);

 tree0->SetBranchAddress("cosmict_flag_4",&cosmict_flag_4);
 tree0->SetBranchAddress("cosmict_4_filled",&cosmict_4_filled);
 tree0->SetBranchAddress("cosmict_4_flag_inside",&cosmict_4_flag_inside);
 tree0->SetBranchAddress("cosmict_4_angle_beam",&cosmict_4_angle_beam);
 tree0->SetBranchAddress("cosmict_4_connected_showers",&cosmict_4_connected_showers);

 
 tree1->SetBranchAddress("cosmict_flag_1",&cosmict_flag_1);
 
 tree1->SetBranchAddress("cosmict_flag_2", &cosmict_flag_2);
 tree1->SetBranchAddress("cosmict_2_filled", &cosmict_2_filled);
 tree1->SetBranchAddress("cosmict_2_particle_type", &cosmict_2_particle_type);
 tree1->SetBranchAddress("cosmict_2_n_muon_tracks", &cosmict_2_n_muon_tracks);
 tree1->SetBranchAddress("cosmict_2_total_shower_length", &cosmict_2_total_shower_length);
 tree1->SetBranchAddress("cosmict_2_flag_inside", &cosmict_2_flag_inside);
 tree1->SetBranchAddress("cosmict_2_angle_beam", &cosmict_2_angle_beam);
 tree1->SetBranchAddress("cosmict_2_flag_dir_weak", &cosmict_2_flag_dir_weak);
 tree1->SetBranchAddress("cosmict_2_dQ_dx_end", &cosmict_2_dQ_dx_end);
 tree1->SetBranchAddress("cosmict_2_dQ_dx_front", &cosmict_2_dQ_dx_front);
 tree1->SetBranchAddress("cosmict_2_theta", &cosmict_2_theta);
 tree1->SetBranchAddress("cosmict_2_phi", &cosmict_2_phi);
 tree1->SetBranchAddress("cosmict_2_valid_tracks", &cosmict_2_valid_tracks);

 tree1->SetBranchAddress("cosmict_flag_4",&cosmict_flag_4);
 tree1->SetBranchAddress("cosmict_4_filled",&cosmict_4_filled);
 tree1->SetBranchAddress("cosmict_4_flag_inside",&cosmict_4_flag_inside);
 tree1->SetBranchAddress("cosmict_4_angle_beam",&cosmict_4_angle_beam);
 tree1->SetBranchAddress("cosmict_4_connected_showers",&cosmict_4_connected_showers);

 tree2->SetBranchAddress("cosmict_flag_1",&cosmict_flag_1);
 
 tree2->SetBranchAddress("cosmict_flag_2", &cosmict_flag_2);
 tree2->SetBranchAddress("cosmict_2_filled", &cosmict_2_filled);
 tree2->SetBranchAddress("cosmict_2_particle_type", &cosmict_2_particle_type);
 tree2->SetBranchAddress("cosmict_2_n_muon_tracks", &cosmict_2_n_muon_tracks);
 tree2->SetBranchAddress("cosmict_2_total_shower_length", &cosmict_2_total_shower_length);
 tree2->SetBranchAddress("cosmict_2_flag_inside", &cosmict_2_flag_inside);
 tree2->SetBranchAddress("cosmict_2_angle_beam", &cosmict_2_angle_beam);
 tree2->SetBranchAddress("cosmict_2_flag_dir_weak", &cosmict_2_flag_dir_weak);
 tree2->SetBranchAddress("cosmict_2_dQ_dx_end", &cosmict_2_dQ_dx_end);
 tree2->SetBranchAddress("cosmict_2_dQ_dx_front", &cosmict_2_dQ_dx_front);
 tree2->SetBranchAddress("cosmict_2_theta", &cosmict_2_theta);
 tree2->SetBranchAddress("cosmict_2_phi", &cosmict_2_phi);
 tree2->SetBranchAddress("cosmict_2_valid_tracks", &cosmict_2_valid_tracks);

 tree2->SetBranchAddress("cosmict_flag_4",&cosmict_flag_4);
 tree2->SetBranchAddress("cosmict_4_filled",&cosmict_4_filled);
 tree2->SetBranchAddress("cosmict_4_flag_inside",&cosmict_4_flag_inside);
 tree2->SetBranchAddress("cosmict_4_angle_beam",&cosmict_4_angle_beam);
 tree2->SetBranchAddress("cosmict_4_connected_showers",&cosmict_4_connected_showers);
